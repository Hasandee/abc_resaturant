...
import com.abcRestaurantBackend.abcRestaurantBackend.Service.FileStorageService;
...
public class GalleryController {
    ...
    public ResponseEntity<Gallery> addItemToGallery(@PathVariable String galleryId, @RequestBody Gallery.Item item) {
    ...
    public ResponseEntity<Gallery> updateItemInGallery(@PathVariable String galleryId, @PathVariable String itemId, @RequestBody Gallery.Item item) {
